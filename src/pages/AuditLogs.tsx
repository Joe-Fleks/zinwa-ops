...
type ViewTab = 'change_history' | 'engagements';
...
export default function AuditLogs() {
  ...
  const [activeTab, setActiveTab] = useState<ViewTab>('change_history');
  ...
  const tabs: { key: ViewTab; label: string; icon: React.ReactNode; adminOnly?: boolean }[] = [
    { key: 'change_history', label: 'Change History', icon: <ScrollText className="w-4 h-4" /> },
    { key: 'engagements', label: 'User Engagements', icon: <Activity className="w-4 h-4" />, adminOnly: true },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      {activeTab === 'engagements' && isGlobalAdmin && (
