...
import { MessageSquare, X, Send, Plus, Trash2, Loader2, ChevronLeft, AlertCircle, Bot, User } from 'lucide-react';
...
export default function ChatPanel() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed bottom-24 right-6 z-50 w-[420px] max-w-[calc(100vw-48px)] bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col transition-all duration-300 origin-bottom-right ${
          isOpen
      ...
      >
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 bg-gradient-to-r from-teal-600 to-teal-700 rounded-t-2xl">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-semibold text-white">ZINWA AI Assistant</p>
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className="p-1.5 rounded hover:bg-white/20 text-white transition-colors text-xs font-medium"
        ...
        {view === 'history' ? (
                ...
                {sessions.map(session => (
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 hover:bg-gray-50 transition-colors group ${
                      activeSessionId === session.id ? 'bg-teal-50' : ''
                    }`}
                  >
          ...
          <>
                  ...
                  <div className="mt-4 grid gap-2 w-full max-w-[300px]">
                    {[
                      ...
                      <button
                        ...
                        className="text-left text-xs px-3 py-2 rounded-lg border border-gray-200 text-gray-600 hover:bg-teal-50 hover:border-teal-200 hover:text-teal-700 transition-colors"
                      >
                        {q}
                      </button>
                    ))}
            ...
            <div className="border-t border-gray-100 px-3 py-2.5 bg-gray-50/50 rounded-b-2xl">
              {streaming && (
                <button
                  onClick={handleStop}
              ...
              <div className="flex items-end gap-2">
                <textarea
                  ...
                  rows={1}
                  disabled={streaming}
                  className="flex-1 resize-none border border-gray-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent disabled:opacity-50 bg-white max-h-[80px]"
