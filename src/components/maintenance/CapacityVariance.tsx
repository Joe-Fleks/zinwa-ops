          ...
          <div className="flex gap-0.5 bg-gray-200 rounded-md p-0.5">
            <button
              ...
              className={`px-3 py-1 text-sm font-semibold rounded transition-all ${
                viewMode === 'date' ? 'bg-blue-300 text-blue-900 shadow-sm' : 'text-gray-500 hover:text-gray-700 hover:bg-blue-100'
              }`}
            >Date</button>
            <button
              onClick={() => setViewMode('month')}
              className={`px-3 py-1 text-sm font-semibold rounded transition-all ${
                viewMode === 'month' ? 'bg-blue-300 text-blue-900 shadow-sm' : 'text-gray-500 hover:text-gray-700 hover:bg-blue-100'
              }`}
            >Month</button>
          </div>
